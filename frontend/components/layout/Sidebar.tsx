...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex md:flex-col md:w-64 md:fixed md:top-0 md:bottom-0 md:left-0 z-40 bg-[var(--color-bg-secondary)] border-r border-[var(--color-border)]">
      {/* ロゴエリア */}
          ...
          return (
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <span className="block text-[11px] leading-tight text-[var(--color-text-muted)] mt-0.5">
                  {link.labelJa}
                </span>
              </div>
            </Link>
